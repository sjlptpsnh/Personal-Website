            ...
            <div className=''>
              <div className='font-normal text-lg text-right'>FIND ME AT</div>
                <div className='flex gap-2 md:gap-4 mt-4 justify-end text-[#77818F]'>
                  ...
                  <a href="https://www.instagram.com/sjlptpsnh/" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
                  ...
                  <a href="https://www.linkedin.com/in/sjlptpsnh/" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
